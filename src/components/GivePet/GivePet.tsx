...
export const GivePet: React.FC = memo(() => {
  return (
    <div className="give-pet page__section">
      <Container>
        <div className="give-pet__content">
          ...
          <div className="give-pet__info">
            ...
            <p className="give-pet__text">
              Share your kindness and love by posting an ad for an animal on our service.
              Together we create hope and opportunity for every homeless soul to find a happy home.
